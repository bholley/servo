...
use wrapper::{GeckoDocument, GeckoNode};
use wrapper::NonOpaqueStyleData;
...
pub extern "C" fn Servo_RestyleDocument(doc: *mut RawGeckoDocument) -> () {
    ...
    let mut parallel_traversal: WorkQueue<SharedStyleContext, WorkQueueData> = WorkQueue::new("StyleWorker", thread_state::LAYOUT, num_threads);
